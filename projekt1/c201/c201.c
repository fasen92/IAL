...
void List_Dispose( List *list ) {
	if(list->firstElement != NULL){
		ListElementPtr delElem = list->firstElement;
		ListElementPtr next;
...
void List_InsertFirst( List *list, int data ) {
	ListElementPtr newElem =  malloc(sizeof(struct ListElement));
	if(newElem == NULL){
		List_Error();
	}
	newElem->data = data;
...
void List_DeleteFirst( List *list ) {
	if(list->firstElement != NULL){
		...
		if(list->firstElement->nextElement != NULL){
			ListElementPtr nextEL = list->firstElement->nextElement;
...
void List_DeleteAfter( List *list ) {
	if(list->activeElement != NULL){
		if(list->activeElement->nextElement != NULL){
			ListElementPtr nextEL = list->activeElement->nextElement->nextElement;
